...
;(function(root, factory) {
	...
	jet.winarea = function(type) {
		return doc.body[type ? "clientWidth" :"clientHeight"];
	};
	...
	jedfn.setHtml = function(opts){
		...
		// 控件HMTL模板
		var datetopStr = '<div class="jedatetop">' + (!isYYMM ? '<div class="jedateym" style="width:50%;"><i class="prev triangle yearprev" onmouseover="hover(this)" onmouseout="hoverout(this)"></i><span class="jedateyy" ym="24"><em class="jedateyear"></em><em class="pndrop"></em></span><i class="next triangle yearnext" onmouseover="hover(this)" onmouseout="hoverout(this)"></i></div>' + '<div class="jedateym" style="width:50%;"><i class="prev triangle monthprev" onmouseover="hover(this)" onmouseout="hoverout(this)"></i><span class="jedatemm" ym="12"><em class="jedatemonth"></em><em class="pndrop"></em></span><i class="next triangle monthnext" onmouseover="hover(this)" onmouseout="hoverout(this)"></i></div>' :'<div class="jedateym" style="width:100%;"><i class="prev triangle ymprev" onmouseover="hover(this)" onmouseout="hoverout(this)"></i><span class="jedateyy"><em class="jedateyearmonth"></em></span><i class="next triangle ymnext" onmouseover="hover(this)" onmouseout="hoverout(this)"></i></div>') + "</div>";
		...
		if(isYYMM){
			...
			/*//ie不支持hover,使用js模拟
			boxCell.find(".jedayy li").mouseover(function() {
				$(this).addClass("hover");
			}).mouseout(function(){
	...
	jedfn.createDaysHtml = function(ys, ms, opts){
		...
		//ie不支持hover,使用js模拟
		boxCell.find(".jedaul li").mouseover(function() {
			$(this).addClass("hover");
		}).mouseout(function(){
			$(this).removeClass("hover");
		})
	...
	jedfn.chooseYM = function(opts) {
		...
		function eachYearMonth(YY, ymlen) {
			...
			//ie不支持hover,使用js模拟
			boxCell.find(".ymdropul li").mouseover(function() {
				$(this).addClass("hover");
			}).mouseout(function(){
				$(this).removeClass("hover");
			})
	...
	jedfn.events = function(tmsArr,opts){
		...
		if (!isYYMM) {
			...
			var hmsStr = that.setStrhms(opts), hmsevents = function(hmsArr) {
				...
				//ie不支持hover,使用js模拟
				boxCell.find(".jedatehmscon p").mouseover(function() {
					$(this).addClass("hover");
				}).mouseout(function(){
					$(this).removeClass("hover");
				})
